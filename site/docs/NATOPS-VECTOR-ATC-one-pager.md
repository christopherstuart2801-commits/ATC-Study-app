...
**Build:** **v0.7.2 · cite-page-fix** (GitHub Pages)  
**Owner:** LCPL Stuart (CS) · KNFG / MCAS Camp Pendleton (Munn Field) · Radar Final Control syllabus  
...
|-------------------|------|
| **Home** | Position chips — **Radar Final** live; other KNFG positions same pattern when paper lands |
...
- Other-position ACADs, TNR manuals, CWT CAT A–I detail, Vengeance/Coyote, 00-80T, FIG/AOM stay **empty until official paper is uploaded**.

---

## 3. Demo path (2–3 minutes) — exact taps
1. Open live link → confirm statusbar **v0.7.2 · cite-page-fix**.
...
**Live (Radar Final–focused)**
- Sticky Home / Ask / Learn / Sim / Reference (pitch: four tabs above; Sim quiet)
- ACAD checklist → PDF heading Find + chapter-floor landing
- PREV/NEXT SECTION cite walk + ← BACK to Learn
- Study markup (highlight / underline) on cite PDF
...
- ACADs for remaining KNFG positions (same packet pattern ready)
- Detailed charts, nav routes, strip guides, TNR manuals
- 00-80T / 00-80T-114, CWT CAT A–I numbers, Vengeance/Coyote, FIG 2-3 / AOM
...
3. Priority order for next paper uploads (which position / packet after Radar Final).  
