# VECTOR ATC — Monday Dry Run Presentation Pack

**Audience:** Gunny Harris (Radar chief) — practice dry run  
**Later:** Captain Lopez / cabin brief · October NATOPS inspection concept  
**Live:** https://christopherstuart2801-commits.github.io/ATC-Study-app/ · **v0.7.3 · rfd-acad**  
...
| # | Slide | Time |
|---|--------|------|
| 1 | What VECTOR ATC is (and is not) | 1 min |
| 2 | Accuracy bar — non-negotiable | 1 min |
| 3 | Four tabs that matter | 1 min |
| 4 | **LIVE DEMO** — exact tap path | 2–3 min |
| 5 | Live today vs paper-blocked | 1 min |
| 6 | Asks of the chief | 1–2 min |
| 7 | Close / next steps | 30–45 s |

Optional printable outline: § Printable outline (end of this file).

---

## Slide 1 — What it is (and is not)
...
**Is not:**
- Not a replacement for pubs, instructors, or the paper syllabus.
- Not a full simulator brief (SIM tab exists — we are **not** demoing it Monday).
- Not a place for invented freqs, SIDs, minima, or stand-in ACADs.

**Speaker notes:** Lead with “syllabus-aligned study aid.” One sentence on KNFG / Munn Field / Radar Final so Gunny hears position ownership.

---

## Slide 2 — Accuracy bar (non-negotiable for NATOPS)

**On screen / say:**
- **Source-anchored only** — every checklist cite maps to a real JO / FACMAN page.
- **No invented** content: freqs, SIDs, minima, App D-8, other-position ACADs, FIG polish.
- Ship gate: `verify-ask-rfc.js` → **ALL CHECKS PASSED**.
- Empty slots stay empty until **official paper** is uploaded.

**Speaker notes:** This is the inspection story. If asked “can we add X?” → “when the paper packet is uploaded, same pipeline — we do not invent.”

---

## Slide 3 — Four tabs that matter
...
**SIM:** present on the bar; **do not open** in this dry run unless Gunny asks.

**Speaker notes:** Point at the sticky tabs once. “We live in Learn for the demo; Ask/Reference are the same FIND muscle.”

---

## Slide 4 — LIVE DEMO (exact tap path)

**Prep:** Phone or laptop browser · live Pages link · Wi-Fi · statusbar shows **v0.7.3 · rfd-acad**.

| Step | Tap | What you should see |
|------|-----|---------------------|
| 1 | Open live URL | Home; statusbar v0.7.3 |
...
| 5 | **7110.65 2-4-3 · Pilot Acknowledgement** | PDF canvas paints; ~**79 / 732**; heading **2-4-3** visible |
| 6 | **NEXT SECTION** | Next **real cite** (e.g. 2-4-5) — not a header row; Section N/33 updates |
| 7 | **← BACK** | Same Learn checklist; progress tick advances |
| 8 *(optional)* | **Ask** or **Reference** → type `Pilot Acknowledgement` → **FIND** | JO 2-4-3 hit with excerpt |

**If PDF is slow:** wait ~3–5 s on first open (pdf.js + JO load). Do not mash CLOSE.

**Speaker notes:** Narrate “checklist → chapter page → walk cites → back to packet.” That is the whole product story.
...
## Slide 6 — Asks of Radar Chief (Gunny Harris)
...
**Speaker notes:** Pause after #1 and #4 — those are the NATOPS-facing asks. Take notes on #2/#3.
...
| Offline? | Declared offline-capable / on-device docs; first PDF load needs network to Pages assets. |
| Who owns content? | Squadron syllabus + official pubs. App is a viewer/study shell. |
| October inspection angle? | Concept brief: syllabus-aligned tool with a hard accuracy bar — not a claim that it replaces training. |
| App D / FIG mocks? | Skeleton only where sourced; **we do not polish App D FIG mocks** for this brief. |

---

## What NOT to invent / show Monday
...
**Do:**
- Stay on **Home → R/FINAL → Learn → cite → PDF → NEXT → BACK** (+ optional Ask/Reference FIND).
- Repeat the accuracy rule if pressed.
- Offer the one-pager for Gunny to keep.

---

## Printable outline (one sheet)

```
VECTOR ATC — Gunny Harris dry run — Mon 2026-09-21 PT
Live: …/ATC-Study-app/ · v0.7.3 · rfd-acad · LCPL Stuart
...
- [ ] Open live link on the device you will use; confirm **v0.7.3 · rfd-acad**
