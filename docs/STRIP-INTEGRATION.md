...
2026-09-16 11pm night grind: Final Topic 4 Learn checklist split into paper ACAD-0521 (movement) / ACAD-0522 (strips) section headers; added FACMAN FIG D-6 so Appendix D-5–7 (FIG D-4…D-6) is complete; rfcLearn skips hdr rows in progress counts. App D FIG D-1…D-6 still covered; App D-8 still absent from July 2025 PDF body.
